...
from inmuebleslist_app.api.views import (EdificacionAV, EdificacionDetalleAV, EdificacionList, 
                                         EmpresaAV, EmpresaDetalleAV, ComentarioList, 
                                         ComentarioDetail, ComentarioCreate, EmpresaVS, UsuarioComentario)

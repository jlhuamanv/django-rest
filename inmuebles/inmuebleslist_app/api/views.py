...
#             return Response({'Error':'La empresa no encontrada'}, status=status.HTTP_404_NOT_FOUND)
...
class EdificacionDetalleAV(APIView):
    ...
    def get(self, request, pk):
        try:
            ...
            return Response({'Error':'La edificacion no existe'}, status=status.HTTP_404_NOT_FOUND)
